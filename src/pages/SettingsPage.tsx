...
import { Moon, Sun, Bell, Clock, Mail, Calendar, Volume2, VolumeX, Settings } from 'lucide-react';
        ...
        <div className="space-y-4">
          <div>
            ...
            <div className="flex flex-wrap gap-2 sm:space-x-4">
              {[
                { value: 'light', label: 'Light', icon: <Sun className="mr-2" /> },
                { value: 'dark', label: 'Dark', icon: <Moon className="h-5 w-5" /> },
                { value: 'system', label: 'System', icon: <Sun className="mr-2" /> },
              ].map((option) => (
                <button
                  key={option.value}
          ...
          <div className="flex items-center justify-between p-4 bg-bg-color rounded-lg border border-border-color">
            <div className="flex items-center space-x-4">
              <div className="p-2 rounded-full bg-primary bg-opacity-10 text-primary">
                {soundSettings.enabled ? <Volume2 className="text-lg" /> : <VolumeX className="text-lg" />}
              </div>
              <div>
